  ...
  return (
    <section className="py-20 bg-gradient-to-b from-slate-50 via-white to-slate-50 border-t border-slate-200 relative overflow-hidden" id="pengadaan">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative z-10">
        ...
        {/* Quick Links Banner */}
        <FadeIn direction="up">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 sm:gap-4 md:gap-5 lg:gap-6">
            {/* Card 1: Pendaftaran Penyedia Baru */}
            <motion.div
              whileHover={{ y: -6, scale: 1.015 }}
              whileTap={{ scale: 0.985 }}
              transition={{ type: "spring", stiffness: 350, damping: 22 }}
              className="bg-gradient-to-br from-primary-navy via-[#0c2242] to-slate-900 text-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 relative overflow-hidden group border border-white/10 hover:border-amber-400/50 shadow-md hover:shadow-2xl hover:shadow-amber-500/15 transition-colors duration-300 flex flex-col justify-between"
            >
              <div className="absolute -top-6 -right-6 w-28 sm:w-36 h-28 sm:h-36 bg-amber-400/15 rounded-full blur-2xl group-hover:scale-175 group-hover:bg-amber-400/25 transition-all duration-700 pointer-events-none" />
              <div className="absolute inset-0 bg-gradient-to-r from-transparent via-white/5 to-transparent -translate-x-full group-hover:translate-x-full transition-transform duration-1000 ease-in-out pointer-events-none" />
              
              <div>
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-xl sm:rounded-2xl bg-amber-400/15 border border-amber-400/30 flex items-center justify-center mb-3 sm:mb-4 text-accent-gold group-hover:scale-110 group-hover:-rotate-6 group-hover:bg-amber-400/25 transition-all duration-300 shadow-inner shrink-0">
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.985 }}
              transition={{ type: "spring", stiffness: 350, damping: 22 }}
              className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 border border-slate-200/90 hover:border-blue-300 shadow-xs hover:shadow-2xl hover:shadow-blue-500/10 relative overflow-hidden group transition-colors duration-300 flex flex-col justify-between"
            >
              <div className="absolute -top-6 -right-6 w-28 sm:w-36 h-28 sm:h-36 bg-blue-500/10 rounded-full blur-2xl group-hover:scale-175 group-hover:bg-blue-500/20 transition-all duration-700 pointer-events-none" />
              ...
              <div>
                <div className="w-10 h-10 sm:w-11 sm:h-11 md:w-12 md:h-12 rounded-xl sm:rounded-2xl bg-blue-50 border border-blue-100/80 flex items-center justify-center mb-3 sm:mb-4 text-primary-blue group-hover:scale-110 group-hover:-rotate-6 group-hover:bg-primary-blue group-hover:text-white transition-all duration-300 shadow-inner shrink-0">
            ...
            <motion.div
              ...
              whileTap={{ scale: 0.985 }}
              transition={{ type: "spring", stiffness: 350, damping: 22 }}
              className="bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-5 md:p-6 border border-slate-200/90 hover:border-amber-300 shadow-xs hover:shadow-2xl hover:shadow-amber-500/10 relative overflow-hidden group transition-colors duration-300 flex flex-col justify-between"
            >
              <div className="absolute -top-6 -right-6 w-28 sm:w-36 h-28 sm:h-36 bg-amber-500/10 rounded-full blur-2xl group-hover:scale-175 group-hover:bg-amber-500/20 transition-all duration-700 pointer-events-none" />
            ...
            >
              ...
              <div className="space-y-3 mb-6">
                ...
                <div className="space-y-2">
                  {(() => {
                    const docs = (activeModalPackage.documents && activeModalPackage.documents.length > 0)
                      ? activeModalPackage.documents
                      : (activeModalPackage.fileName || activeModalPackage.fileData)
                        ? [{
                            id: 'doc-main',
                            name: activeModalPackage.fileName || 'Kerangka Acuan Kerja (KAK).pdf',
                            size: activeModalPackage.fileSize || '2.4 MB',
                            data: activeModalPackage.fileData,
                            url: activeModalPackage.downloadUrl
                          }]
                        : [];
