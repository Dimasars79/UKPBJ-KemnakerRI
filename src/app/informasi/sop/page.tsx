  ...
  return (
    <div className="bg-slate-50 min-h-screen flex flex-col">
      ...
      <main className="flex-grow pb-24 -mt-[80px] md:-mt-[88px]">
        {/* HERO BANNER SECTION */}
        <section className="relative pt-28 sm:pt-32 lg:pt-36 pb-16 lg:pb-20 overflow-hidden bg-gradient-to-br from-[#071933] via-[#0E284E] to-[#091C36]">
                  ...
                  {filteredSOPs.length > 0 ? (
                    filteredSOPs.map((item, idx) => (
                      <motion.div
                        ...
                        className="bg-white rounded-xl sm:rounded-2xl p-4 sm:p-7 shadow-xs border border-slate-200/80 hover:shadow-md hover:border-slate-300 transition-all duration-300 group"
                      >
