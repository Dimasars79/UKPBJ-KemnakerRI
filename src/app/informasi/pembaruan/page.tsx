            ...
            <div className="lg:col-span-8 space-y-4 sm:space-y-6">
              ...
              {paginatedUpdates.length > 0 ? (
                <>
                  ...
                  {/* PAGINATION CONTROLS */}
                  {totalPages > 1 && (
                    <div className="mt-5 sm:mt-6 flex flex-col sm:flex-row items-center justify-between gap-3 sm:gap-4 bg-white p-3 sm:p-4 rounded-xl sm:rounded-2xl border border-slate-200/80 shadow-xs">
                      ...
                      <div className="flex items-center gap-1 sm:gap-1.5">
                        <button
                          ...
                          className={`px-2.5 py-1 sm:px-3 sm:py-1.5 rounded-lg sm:rounded-xl text-[11px] sm:text-xs font-bold flex items-center gap-1 border transition-all ${
                            currentPage === 1
                        ...
                        {Array.from({ length: totalPages }).map((_, i) => {
                          ...
                          return (
                            <button
                              ...
                              className={`w-7 h-7 sm:w-8 sm:h-8 rounded-lg sm:rounded-xl text-[11px] sm:text-xs font-bold transition-all cursor-pointer ${
                                isActive
